...
#define SNDHDMI_FORMATS (SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE | SNDRV_PCM_FMTBIT_S32_LE)
...
static int sndhdmi_prepare(struct snd_pcm_substream *substream,
